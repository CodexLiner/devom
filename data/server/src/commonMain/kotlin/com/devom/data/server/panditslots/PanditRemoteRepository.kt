...
class PanditRemoteRepositoryImpl : PanditRemoteRepository {
    ...
    override suspend fun removePanditPoojaMapping(input: MapPanditPoojaItemInput): Flow<ResponseResult<String>> =
        ktorClient.delete(PanditEndpoints.RemovePanditPoojaMapping) { setBody(input) }.toResponseResult()
}
